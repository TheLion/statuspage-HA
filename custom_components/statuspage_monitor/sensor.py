...
class _StatusPageEntity(
    ...
    def device_info(self) -> DeviceInfo:
        ...
        provider_class = get_provider(provider_id)
        provider_name = getattr(provider_class, "SHORT_NAME", provider_class.NAME)
        return DeviceInfo(
...
class ProviderInfoSensor(_StatusPageEntity):
    ...
    def __init__(
        ...
        self._provider_id = entry.data.get(CONF_PROVIDER, PROVIDER_STATUSPAGE_IO)
        self._provider_class = get_provider(self._provider_id)
    ...
    def native_value(self) -> str:
        ...
        return getattr(self._provider_class, "SHORT_NAME", self._provider_class.NAME)
    ...
    def entity_picture(self) -> str | None:
        ...
        """
        return _PROVIDER_LOGOS.get(self._provider_id)

    @property
    def icon(self) -> str:
        """Fallback MDI icon used when entity_picture is not available."""
        return _PROVIDER_ICONS.get(self._provider_id, "mdi:information")
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        ...
        attrs: dict[str, Any] = {
            ...
            "icon": _PROVIDER_ICONS.get(self._provider_id, "mdi:information"),
        }
